...
import com.ksyun.media.shortvideo.multicanvasdemo.MultiCanvasRecordActivity;
...
public class RecordProgressController {
    ...
    private class ChangeProgressRunnable implements Runnable {
        @Override
        public void run() {
            if (getTotalRecordTime() >= MultiCanvasRecordActivity.MAX_DURATION) {
    ...
    public boolean isPassMinPoint() {
        ...
        return recordedTime >= MultiCanvasRecordActivity.MIN_DURATION;
    }
    ...
    public int getRecordedTime() {
        return mProgressView.mTotalWidth * MultiCanvasRecordActivity.MAX_DURATION / mProgressView
                .mScreenWidth;
    }
